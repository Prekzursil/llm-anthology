...
PY_PINS = [
    ...
    ("sidecar.py", "sidecar.py", 1027, "loaders.load_corpus(", "the worker call that passes none"),
    ("sidecar.py", "sidecar.py", 1030, "loaders.ingest_exports(", "the SECOND uncancellable call site, added when the export half was wired"),
    ("sidecar.py", "sidecar.py", 957, 'codex_home = _opt_str(params, "codex_home")', "codex_home is read OPTIONAL, never required"),
