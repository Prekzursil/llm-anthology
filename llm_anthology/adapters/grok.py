...
#: `Conversation.provider` and on the spawn-graph node; `sidecar.py:1891` surfaces it to
...
#: line 1390 reads `"provider": meta.model_provider` — and is no longer: `sidecar.py:1891`
